<div class="modal-content">
    <form id="formUpdate" action="{{ $vehiculo->id ? route('vehiculo.update', $vehiculo->id) : route('vehiculo.store') }}" method="post">
        <div class="modal-header">
            <h4 class="modal-title" id="modal-title">{{ $vehiculo->id ? 'Editar vehiculo' : 'Nuevo vehiculo' }}</h4>
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary" id="guardar"><span id="textoBoton">{{ $vehiculo->id ? 'Actualizar' : 'Guardar' }}</span></button>
            </div>
        </div>
