            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h5 class="m-0">ESTUDIANTES <button class="btn btn-primary" onclick="nuevo()"><i class="fas fa-file"></i> Nuevo</button> <a href=""
