            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h5 class="m-0">Tipo comprobantes <button class="btn btn-primary" onclick="nuevo()"><i class="fas fa-file"></i> Nuevo</button> <a href=""
                      class="btn btn-success"><i class="fas fa-file-csv"></i> CSV</a></h5>
                </div>
                <div class="card-body">
                  <div>
                    <form action="{{route('tipoComprobante.index')}}" method="get">
...
@push('scripts')
  <script>
    function nuevo(){
      $.ajax({
            method: 'get',
            url: `{{url('tipoComprobante/create')}}`,
    ...
    function editar(id){
      $.ajax({
            method: 'get',
            url: `{{url('tipoComprobante')}}/${id}/edit`,
            success: function(res){
              $('#modal-update').find('.modal-dialog').html(res);
